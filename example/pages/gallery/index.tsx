  ...
  return (
    <Page className="gallery" title="Gallery" subTitle="画廊，可实现上传图片的展示或幻灯片播放">
      ...
      <Gallery src={imgSrc} show={showSingle}>
        ...
        <GalleryDelete
          onClick={(e: Event, i: number) => alert('click deleted id:' + i + e)}
        />
      </Gallery>

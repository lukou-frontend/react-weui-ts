      ...
      if (this.props.type === 'image') {
        return (
          <div style={wrapStyle} key={idx}>
            ...
            <img src={closeSrc} style={iconStyle} onClick={handleClick} alt="" />
          </div>
        );
      } else {
        return (
  ...
  render() {
    ...
    return (
      <div className={cls}>
        ...
        <div className="weui-uploader__bd" style={{ overflow: 'visible' }}>
          <ul className="weui-uploader__files">
            {this.renderFiles()}
          </ul>
          <div style={{ marginTop: 9, width: size - 2, height: size - 2 }} className="weui-uploader__input-box">
            <input

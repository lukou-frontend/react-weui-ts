(function (global, factory) {
	...
	(factory((global.WeUI = global.WeUI || {}),global.React,global.ReactDOM));
 ...
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-16 17:23:31
 */
    ...
    createClass(Uploader, [{
        ...
        value: function renderFiles() {
            ...
            return this.props.files.map(function (file, idx) {
                ...
                return React.createElement("li", Object.assign({ className: cls, key: idx, style: fileStyle, onClick: handleFileClick }, others), error || status ? React.createElement("div", { className: "weui-uploader__file-content" }, error ? React.createElement(Icon$1, { value: "warn" }) : status) : false);
            });
        }
    }, {
        key: 'render',
        value: function render() {
            var _props = this.props,
                ...
                lang = _props.lang,
                others = objectWithoutProperties(_props, ['className', 'title', 'maxCount', 'files', 'onChange', 'onFileClick', 'lang']);
            ...
            return React.createElement("div", { className: cls }, React.createElement("div", { className: "weui-uploader__hd" }, React.createElement("p", { className: "weui-uploader__title" }, title), React.createElement("div", { className: "weui-uploader__info" }, files.length, "/", maxCount)), React.createElement("div", { className: "weui-uploader__bd" }, React.createElement("ul", { className: "weui-uploader__files" }, this.renderFiles()), React.createElement("div", { className: "weui-uploader__input-box" }, React.createElement("input", Object.assign({ ref: "uploader" //let react to reset after onchange
                , className: "weui-uploader__input", type: "file", accept: "image/*", capture: "camera", onChange: this.handleChange.bind(this) }, inputProps)))));
        }
    }]);
    return Uploader;
}(React.Component);
 ...
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-16 17:30:05
 */
...
var Toast$1 = function (_React$Component) {
    ...
    createClass(Toast, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { style: { display: show ? 'block' : 'none' } }, React.createElement(Mask$1, { transparent: true }), React.createElement("div", Object.assign({ className: cls }, others), React.createElement(Icon$1, { value: icon, size: iconSize, className: "weui-icon_toast" }), React.createElement("p", { className: "weui-toast_content" }, children)));
        }
    }]);
    return Toast;
}(React.Component);
...
var Progress$1 = function Progress(props) {
    ...
    return React.createElement("div", Object.assign({ className: cls }, others), React.createElement("div", { className: "weui-progress__bar" }, React.createElement("div", { className: "weui-progress__inner-bar", style: { width: pgWdith + '%' } })), showCancel ? React.createElement("a", { href: "javascript:;", className: "weui-progress__opr", onClick: function onClick(e) {
        ...
        } }, React.createElement(Icon$1, { value: "cancel" })) : false);
};
...
var ActionSheet$1 = function (_React$Component) {
    ...
    createClass(ActionSheet, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: styleType === 'android' ? 'weui-skin_android' : '' }, React.createElement(Mask$1, { style: { display: show ? 'block' : 'none' }, onClick: this.handleMaskClick }), React.createElement("div", Object.assign({ className: cls }, others), React.createElement("div", { className: "weui-actionsheet__menu" }, this.renderMenuItem()), React.createElement("div", { className: "weui-actionsheet__action" }, this.renderActions())));
        }
    }]);
    return ActionSheet;
}(React.Component);
...
var Msg$1 = function (_React$Component) {
    ...
    createClass(Msg, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", Object.assign({ className: cls }, others), React.createElement("div", { className: "weui-msg__icon-area" }, React.createElement(Icon$1, { value: type, size: 'large' })), React.createElement("div", { className: "weui-msg__text-area" }, title ? React.createElement("h2", { className: "weui-msg__title" }, title) : false, description ? React.createElement("p", { className: "weui-msg__desc" }, description) : false, children), React.createElement("div", { className: "weui-msg__opr-area" }, React.createElement(ButtonArea, null, this._renderButtons())), React.createElement("div", { className: "weui-msg__extra-area" }, elFooter()));
        }
    }]);
    return Msg;
}(React.Component);
 ...
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-17 13:49:45
 */
...
var PanelFooter = function (_React$Component) {
    ...
    createClass(PanelFooter, [{
        ...
        value: function render() {
            ...
            return React.createElement(Component$$1, Object.assign({ className: cls }, others), children);
        }
    }]);
    return PanelFooter;
}(React.Component);
 ...
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-16 18:37:36
 */
 ...
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-16 18:04:41
 */
...
var SearchBar$1 = function (_React$Component) {
    ...
    createClass(SearchBar, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: clz }, React.createElement("form", { className: 'weui-search-bar__form', onSubmit: this.submitHandle.bind(this) }, React.createElement("div", { className: 'weui-search-bar__box' }, React.createElement(Icon$1, { value: 'search' }), React.createElement("input", { ref: this.searchInput, type: 'search', name: searchName, className: 'weui-search-bar__input', placeholder: placeholder, onFocus: function onFocus() {
                ...
                }, style: { display: this.state.text ? 'none' : undefined } }, React.createElement(Icon$1, { value: 'search' }), React.createElement("span", null, placeholder))), React.createElement("a", { className: 'weui-search-bar__cancel-btn', onClick: this.cancelHandle.bind(this) }, this.props.lang.cancel));
        }
    }]);
    return SearchBar;
}(React.Component);
...
var FlexItem = function FlexItem(props) {
    ...
    return React.createElement(Component$$1, Object.assign({ className: "weui-flex__item" }, others), children);
};
FlexItem.propTypes = {
    /**
 ...
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-16 11:05:12
 */
//1.0.0 components
...
var Swiper$1 = function (_React$Component) {
...
var Gallery = function (_React$Component) {
    ...
    createClass(Gallery, [{
        ...
        value: function renderImages(imgs) {
            ...
            return React.createElement("div", { className: "weui-gallery__img" }, React.createElement(Swiper$1, { indicators: false, defaultIndex: this.props.defaultIndex, onChange: function onChange(next) {
...
var GalleryDelete = function GalleryDelete(props) {
    ...
    return React.createElement("a", Object.assign({ className: cls }, others), React.createElement(Icon$1, { value: "delete", className: "weui-icon_gallery-delete" }));
};

/*
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-16 17:57:11
 */
...
var LoadMore$1 = function LoadMore(props) {
  ...
  return React.createElement("div", Object.assign({ className: cls }, others), loading ? React.createElement(Icon$1, { value: 'loading' }) : false, React.createElement("span", { className: "weui-loadmore__tips" }, children));
};
 ...
 * @Author: 刘佑祥
 * @LastEditors: 刘佑祥
 * @LastEditTime: 2020-07-16 15:48:52
 */
...
var Picker = function (_React$Component) {
    ...
    createClass(Picker, [{
        ...
        value: function render() {
            ...
            return this.props.show ? React.createElement("div", null, React.createElement(Mask$1, { className: maskCls, onClick: function onClick(e) {
...
var Badge$1 = function (_React$Component) {
...
var Popup = function (_React$Component) {
    ...
    createClass(Popup, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", null, React.createElement(Mask$1, { transparent: enableMask, style: { display: show ? 'block' : 'none' }, onClick: onRequestClose }), React.createElement("div", Object.assign({ className: cls }, others), children));
        }
    }]);
    return Popup;
}(React.Component);
...
var PullToRefresh$1 = function (_React$Component) {
...
PullToRefresh$1.defaultProps = {
    ...
    loaderDefaultIcon: function loaderDefaultIcon(progress) {
        ...
        return React.createElement("div", { style: { flex: 1, padding: '5px' } }, React.createElement(Icon$1, { value: progress !== 100 ? 'download' : 'success', style: style }));
    },
    loaderLoadingIcon: React.createElement(LoadMore$1, { loading: true }),
...
var InfiniteLoader$1 = function (_React$Component) {
...
InfiniteLoader$1.defaultProps = {
    height: '100vh',
    triggerPercent: 75,
    loaderLoadingIcon: React.createElement(LoadMore$1, { loading: true }, " Loading... "),
    loaderDefaultIcon: React.createElement(LoadMore$1, { showLine: true }, " No Data"),
    disable: false
};

var Page$1 = function (_React$Component) {
    ...
    createClass(Page, [{
        ...
        value: function renderContent(children, ptr, infiniteLoader) {
            ...
            var ContentWithInfiniteLoader = React.createElement(InfiniteLoader$1, { height: "100%", disable: this.state.ptrRefreshing, onScroll: function onScroll(e) {
            ...
            if (ptr && !infiniteLoader) return React.createElement(PullToRefresh$1, { onRefresh: this.handleRefresh, disable: !this.state.contentScrollOnTop }, children);
            return React.createElement(PullToRefresh$1, { onRefresh: this.handleRefresh, disable: !this.state.contentScrollOnTop }, ContentWithInfiniteLoader);
        }
    }, {
        key: 'render',
        value: function render() {
...
exports.ActionSheet = ActionSheet$1;
...
exports.MediaBoxBody = PanelBody$2;
...
exports.PullToRefresh = PullToRefresh$1;
exports.InfiniteLoader = InfiniteLoader$1;
exports.Swiper = Swiper$1;
exports.Page = Page$1;

      ...
      createClass(Uploader, [{
          ...
          value: function renderFiles() {
              ...
              return this.props.files.map(function (file, idx) {
                  ...
                  if (_this4.props.type === 'image') {
                      ...
                      return React.createElement("li", Object.assign({ className: cls, key: idx, style: videofileStyle, onClick: handleFileClick }, others), React.createElement(Icon, { value: "clear", style: iconStyle, onClick: handleClick }), React.createElement("img", { src: imgSrc, style: btnStyle }), error || status ? React.createElement("div", { className: "weui-uploader__file-content" }, error ? React.createElement(Icon, { value: "warn" }) : status) : false);
                  }
              });
          }
      }, {
          ...
          value: function render() {
              var _props = this.props,
                  ...
                  others = objectWithoutProperties(_props, ['className', 'maxCount', 'files', 'onChange', 'onFileClick', 'lang', 'maxsize', 'onOversize', 'type', 'onDelete', 'currentVideo', 'showTitle']);

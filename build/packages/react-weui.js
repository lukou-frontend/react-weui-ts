      ...
      createClass(Uploader, [{
          ...
          value: function handleChange(e) {
              ...
              var _loop = function _loop(key) {
                  if (!_files.hasOwnProperty(key)) return 'continue';
                  var file = _files[key];
                  _this3.handleFile(file, function (_file, _e) {
                      if (file.size / (1024 * 1024) < _this3.props.maxsize) {
                          _this3.props.onOversize(file.size);
                      }
          ...
          value: function render() {
              var _props = this.props,
                  ...
                  myFileType = _props.myFileType,
                  onOversize = _props.onOversize,
                  maxsize = _props.maxsize,
                  lang = _props.lang,
                  others = objectWithoutProperties(_props, ['className', 'maxCount', 'files', 'onChange', 'onFileClick', 'myFileType', 'onOversize', 'maxsize', 'lang']);

      ...
      createClass(Uploader, [{
          ...
          value: function render() {
              var _props = this.props,
                  ...
                  size = _props.size,
                  showAddInput = _props.showAddInput,
                  others = objectWithoutProperties(_props, ['className', 'maxCount', 'files', 'onChange', 'onFileClick', 'lang', 'maxsize', 'onOversize', 'type', 'onDelete', 'currentVideo', 'showTitle', 'size', 'showAddInput']);

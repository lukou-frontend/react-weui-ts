          ...
          value: function renderFiles() {
              ...
              return this.props.files.map(function (file, idx) {
                  var url = file.url,
                      ...
                      type = file.type,
                      others = objectWithoutProperties(file, ['url', 'error', 'status', 'onClick', 'type']);
                  ...
                  if (/image/g.test(file.type)) {
                      ...
                      return React.createElement("video", { src: _this4.state.videoSrc, className: cls }, error || status ? React.createElement("div", { className: "weui-uploader__file-content" }, error ? React.createElement(Icon, { value: "warn" }) : status) : false);
                  }
              });
          }
      }, {

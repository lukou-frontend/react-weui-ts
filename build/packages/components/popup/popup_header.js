...
const PopupHeader = (props) => {
    ...
    return (React.createElement("div", { className: cls },
        React.createElement("a", { className: "weui-popup__action", onClick: leftOnClick }, left),
        React.createElement("a", { className: "weui-popup__action", onClick: rightOnClick }, right)));
};

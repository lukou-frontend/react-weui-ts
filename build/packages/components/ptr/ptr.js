...
class PullToRefresh extends React.Component {
    ...
    handleTouchEnd() {
        ...
        this.setState({
            ...
            if (loading)
                this.props.onRefresh(this.resolveRefresh);
        });
    }
    render() {
        ...
        return (React.createElement("div", Object.assign({ className: cls, style: containerStyle }, domProps),
            React.createElement("div", { className: "react-weui-ptr__loader", style: loaderStyle }, this.state.loading ?
                loaderLoadingIcon :
                loaderDefaultIcon(this.state.pullPercent)),
            React.createElement("div", { className: "react-weui-ptr__content", ref: "content", onTouchStart: this.handleTouchStart, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd }, children)));
    }
}
...
PullToRefresh.defaultProps = {
    ...
    loaderDefaultIcon: (progress) => {
        ...
        return (React.createElement("div", { style: { flex: 1, padding: '5px' } },
            React.createElement(Icon, { value: progress !== 100 ? 'download' : 'success', style: style })));
    },
    loaderLoadingIcon: React.createElement(LoadMore, { loading: true }),
    onRefresh: (resolve) => setTimeout(() => resolve(), 1000),
    disable: false
};

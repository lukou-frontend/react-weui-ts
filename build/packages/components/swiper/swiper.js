...
class Swiper extends React.Component {
    ...
    handleTouchStart(e) {
        if (this.state.touching || this.props.children.length <= 1)
            return;
        let og = 0;
    ...
    handleTouchEnd() {
        ...
        if (this.props.onChange)
            this.props.onChange(ogIndex, currentIndex);
    }
    renderPagination() {
        // @ts-ignore
    ...
    render() {
        ...
        return (React.createElement("div", { className: clx, onTouchStart: this.handleTouchStart, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd, style: containerStyle, ref: "container" },
            React.createElement("div", { className: "react-weui-swiper__wrapper", style: wrapperStyle }, children.map((child, i) => {
            ...
            indicators ?
                React.createElement("div", { className: "react-weui-swiper__pagination" }, this.renderPagination())
                : false));
    }
}
Swiper.propTypes = {

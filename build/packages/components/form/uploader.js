        ...
        return this.props.files.map((file, idx) => {
            ...
            if (this.props.type === 'image') {
                return (React.createElement("div", { style: wrapStyle, key: idx },
                    React.createElement("li", Object.assign({ className: cls, key: idx, style: fileStyle, onClick: handleFileClick }, others), error || status ?
                        React.createElement("div", { className: "weui-uploader__file-content" }, error ? React.createElement(Icon, { value: "warn" }) : status)
                        : false),
                    React.createElement("img", { src: closeSrc, style: iconStyle, onClick: handleClick, alt: "" })));
            }
            else {
                return (React.createElement("div", { style: wrapStyle, key: idx },
    ...
    render() {
        ...
        return (React.createElement("div", { className: cls },
            ...
            React.createElement("div", { className: "weui-uploader__bd", style: { overflow: 'visible' } },
                ...
                React.createElement("div", { style: { marginTop: 9 }, className: "weui-uploader__input-box" },
